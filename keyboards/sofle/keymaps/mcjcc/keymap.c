...
KC_ESC, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , KC_MUTE,       KC_CAPS, KC_H    , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,
...
[_RAISE] = LAYOUT_via(
  ...
  _______, XXXXXXX, KC_LEFT, KC_UP  , KC_DOWN, KC_RGHT, _______,       _______, KC_LEFT, KC_DOWN, KC_UP , KC_RGHT , KC_EQL , KC_PIPE,
