...
KC_LSFT, KC_Z  , KC_X   , KC_C   , KC_V   , KC_B   , KC_VOLD,       KC_PGDN, KC_N    , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
              KC_LCTRL, KC_LALT ,KC_LGUI,TG(_LOWER), KC_ENT ,       KC_ENT , TG(_RAISE),KC_SPC, KC_RALT, TO(0)
),
/*
 * COLEMAK - Vanilla
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_COLEMAK] = LAYOUT_via(
  ...
  KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_D   , KC_V   , KC_VOLD,       KC_PGDN,  KC_K    , KC_H   , KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,
                   KC_LCTRL, KC_LALT ,KC_LGUI,TG(_LOWER), KC_ENT ,       KC_ENT , TG(_RAISE),KC_SPC, KC_RALT, KC_RCTRL
),
...
[_LOWER] = LAYOUT_via(
  ...
  _______, KC_INS , KC_PSCR, KC_APP , XXXXXXX , XXXXXXX, _______,    _______,  KC_PGUP, _______, KC_UP  , KC_MINS, KC_EQL, _______,
  _______, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX , KC_CAPS, _______,    _______,  KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______ , _______,
  _______, KC_UNDO, KC_CUT , KC_COPY, KC_PASTE, XXXXXXX, _______,    _______,  KC_LBRC, KC_RBRC, XXXXXXX, _______, XXXXXXX, _______,
                   _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______
)
};
